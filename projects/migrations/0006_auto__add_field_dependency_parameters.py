...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dependency.parameters'
        db.add_column(u'projects_dependency', 'parameters',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dependency.parameters'
        db.delete_column(u'projects_dependency', 'parameters')
