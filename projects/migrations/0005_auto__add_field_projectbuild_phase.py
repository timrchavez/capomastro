...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectBuild.phase'
        db.add_column(u'projects_projectbuild', 'phase',
                      self.gf('django.db.models.fields.CharField')(default='UNKNOWN', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectBuild.phase'
        db.delete_column(u'projects_projectbuild', 'phase')
